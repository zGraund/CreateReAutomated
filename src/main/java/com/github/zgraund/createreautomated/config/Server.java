...
public class Server extends ConfigBase {
    ...
    public final ConfigFloat cutterImpact = f(
            128,
            0,
            "cutterImpact",
            "[in Stress Units]",
            "How much stress impact does the cutter generate. Note that this cost is doubled for every speed increase it receives."
    );
    ...
    public DoubleSupplier getCutterImpact(Block block) {
        return block == ModBlocks.JET_CUTTER.get() ? cutterImpact::get : null;
    }
