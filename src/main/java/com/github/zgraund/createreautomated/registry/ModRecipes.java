...
public class ModRecipes {
    ...
    public static final DeferredHolder<RecipeType<?>, RecipeType<ExtractorRecipe>> EXTRACTOR_RECIPE = RECIPE_TYPES.register(
            "extracting",
    ...
    public static final Supplier<RecipeSerializer<ExtractorRecipe>> EXTRACTOR_RECIPE_SERIALIZER = RECIPE_SERIALIZERS.register(
            "extracting",
            () -> new ExtractorRecipe.Serializer(ExtractorRecipe::new)
    );
